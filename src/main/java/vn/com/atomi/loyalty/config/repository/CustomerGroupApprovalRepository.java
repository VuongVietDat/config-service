...
public interface CustomerGroupApprovalRepository
  ...
  @Query(
      "select cga from CustomerGroupApproval cga where cga.deleted = false "
          + "and cga.approvalStatus = vn.com.atomi.loyalty.config.enums.ApprovalStatus.ACCEPTED "
  ...
  @Query(
      value =
          "select cga "
              ...
              + "       and cga.approvalStatus in (vn.com.atomi.loyalty.config.enums.ApprovalStatus.ACCEPTED, vn.com.atomi.loyalty.config.enums.ApprovalStatus.REJECTED))) "
